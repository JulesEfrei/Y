...
export type SignOutMutation = { __typename?: 'Mutation', signOut: { __typename?: 'AuthResponse', success: boolean, message: string } | { __typename?: 'CategoryResponse', success: boolean, message: string } | { __typename?: 'CommentLikeResponse', success: boolean, message: string } | { __typename?: 'CommentResponse', success: boolean, message: string } | { __typename?: 'LikeResponse', success: boolean, message: string } | { __typename?: 'PostResponse', success: boolean, message: string } };
